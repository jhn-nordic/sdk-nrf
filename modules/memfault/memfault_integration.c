...
/* Device ID check */
BUILD_ASSERT((sizeof(CONFIG_MEMFAULT_NCS_DEVICE_ID) > 1) || CONFIG_MEMFAULT_NCS_DEVICE_SERIAL_USE_IMEI,
...
BUILD_ASSERT(sizeof(CONFIG_MEMFAULT_NCS_FW_VERSION_STATIC) > 1, "Firmware version must be configured");
#endif
