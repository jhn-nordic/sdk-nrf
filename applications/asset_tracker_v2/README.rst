...
The application supports Assisted GNSS.
To set the source of the AGPS data, set the following options:

* :option:`CONFIG_AGPS_SRC_SUPL` - Sets the external SUPL Client library as AGPS data source. See the documentation on :ref:`supl_client_lib`.
* :option:`CONFIG_AGPS_SRC_NRF_CLOUD` - Sets nRF Cloud as AGPS data source. You must set nRF Cloud as the firmware cloud backend.
