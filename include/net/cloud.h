 ...
 * param[in] handler Handler to receive events from the backend.
 * param[in] user_data Pointer to user defined data that will be passed on as
...
/**@brief Sets the user defined data that's passed as argument to cloud event
 * 	  handler.
 *
 * param[in] cloud Pointer to cloud backend structure.
 * param[in] user_data Pointer to user defined data that will be passed on as
...
/**
 * @brief Gets binding (pointer) to cloud backend if a registered backend
 *	  matches the provided name.
 *
 * @param[in] name String with the name of the cloud backend.
 *
